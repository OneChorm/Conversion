...
# TRAIN_FILE = 'data/first/shanghai/data_en2ch/train_en2ch.txt'
# DEV_FILE = "data/first/shanghai/data_en2ch/dev_en2ch.txt"
# TEST_FILE = "data/first/shanghai/data_en2ch/test_en2ch.txt"
# SAVE_FILE = 'data/first/shanghai/data_en2ch/model_en2ch_word.pt'

# second.1
# TRAIN_FILE = 'data/second/order/ChemBook_no_split_dev/data_en2ch/train_en2ch.txt'
# DEV_FILE = "data/second/order/ChemBook_no_split_dev/data_en2ch/dev_en2ch.txt"
# TEST_FILE = "data/second/order/ChemBook_no_split_dev/data_en2ch/test_en2ch.txt"
# SAVE_FILE = 'data/second/order/ChemBook_no_split_dev/data_en2ch/model_en2ch_word.pt'

# second.2
# TRAIN_FILE = 'data/second/order/shanghai/data_en2ch/train_en2ch.txt'
# DEV_FILE = "data/second/order/shanghai/data_en2ch/dev_en2ch.txt"
...
def evaluate(data, model):
    wb = op.load_workbook('data/first/shanghai/data_en2ch/en2ch_Result_word.xlsx')
    ws = wb.create_sheet('test_en2ch')
    ws.append(['Source', 'Targe', 'shanghai_Result'])
    with torch.no_grad():
        with open('data/second/order/ChemBook_no_split_dev/data_en2ch/predict_en2ch_word.txt', 'w', encoding="utf-8") as file:
            for i in range(len(data.test_en)):
                ...
                ws.append(d)
                wb.save('data/second/order/ChemBook_no_split_dev/data_en2ch/en2ch_Result_word.xlsx')
