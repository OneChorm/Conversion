...
# # first
TRAIN_FILE = 'data/first/shanghai/data_ch2en/train_ch2en.txt'  # 训练集
DEV_FILE = "data/first/shanghai/data_ch2en/dev_ch2en.txt"      # 验证集
TEST_FILE = "data/first/shanghai/data_ch2en/test_ch2en.txt"
SAVE_FILE = 'data/first/shanghai/data_ch2en/model_ch2en_char.pt'         # 模型保存路径

# second.1
# TRAIN_FILE = 'data/second/order/ChemBook_no_split_dev/data_ch2en/train_ch2en.txt'  # 训练集
# DEV_FILE = "data/second/order/ChemBook_no_split_dev/data_ch2en/dev_ch2en.txt"      # 验证集
# TEST_FILE = "data/second/order/ChemBook_no_split_dev/data_ch2en/test_ch2en.txt"
# SAVE_FILE = 'data/second/order/ChemBook_no_split_dev/data_ch2en/model_ch2en_char.pt'         # 模型保存路径

# second.2
# TRAIN_FILE = 'data/second/order/shanghai/data_ch2en/train_ch2en.txt'  # 训练集
# DEV_FILE = "data/second/order/shanghai/data_ch2en/dev_ch2en.txt"      # 验证集
...
class PrepareData:
    ...
    def __init__(self, train_file, dev_file, test_file):
        ...
        self.train_en, self.train_cn = self.load_data("data/second/order/ChemBook_no_split_dev/data_ch2en/train_ch2en.txt")
    ...
    def load_data(self, path):
        ...
        with open(path, mode="r", encoding="utf-8") as f:
            for line in f.readlines():
                ...
                sent_cn, sent_en = line_split[1].replace("\n",''), line_split[0]
...
def evaluate(data, model):
    wb = op.load_workbook('data/second/order/ChemBook_no_split_dev/data_ch2en/ch2en_Result_char.xlsx')
    ws = wb.create_sheet('test_ch2en')  # 创建子表
    ...
    with torch.no_grad():
        for i in range(len(data.dev_cn)):
            ...
            d = cn_sent2excle, en_sent2excle, "".join(translation)
            ws.append(d)
            wb.save('data/second/order/ChemBook_no_split_dev/data_ch2en/ch2en_Result_char.xlsx')
